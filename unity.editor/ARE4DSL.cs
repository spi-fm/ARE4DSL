...
public class Are4Dsl
{
    
   
    [MenuItem("ARE4DSL/Generate Folders")]
    static void CreateFolders()
    {
        string[] folders = new string[4];
        folders[0]=System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Meta_models/classes/";
        folders[1] =System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Meta_models/sources/";
        folders[2] = System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Model/";
        folders[3] = System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Prefabs/";
    ...
    [MenuItem("ARE4DSL/Generate Editor")]
    static void CreateEditor()
    {
        string[] fileArray = Directory.GetFiles(@System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Meta_models/sources/", "*.ecore");
        ...
        foreach (string file in fileArray)
        {
            ...
            string folderPath = System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Meta_models/classes/"+ Path.GetFileNameWithoutExtension(file);
    ...
    static void CreateMetaModelsClasses(string metaModelName, string folderPath)
    {
        ...
        myProcess.StartInfo.Arguments = "-jar " + System.Environment.CurrentDirectory + "/Assets/Editor/modules/acceleo.jar " + System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Meta_models/sources/" + metaModelName+" " + folderPath;
        myProcess.Start();
    ...
    {
        //string fileArray = Directory.GetFiles(@System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Model/", "*.xmi")[0];

        string text = System.IO.File.ReadAllText(Directory.GetFiles(@System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Model/", "*.xmi")[0]);
    ...
    static void CreateEditorGameObjects()
    {
        ...
        string localPath = System.Environment.CurrentDirectory + "/Assets/Are4Dsl/Prefabs/" + editor.name + ".prefab";
